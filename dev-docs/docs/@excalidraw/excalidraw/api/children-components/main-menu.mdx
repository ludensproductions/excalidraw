    ...
    <div style={{ height: "500px" }}>
      <Excalidraw>
        <MainMenu>
          ...
          <MainMenu.ItemLink href="https://excalidraw.issirmax.mx">
            Excalidraw
          </MainMenu.ItemLink>
        </MainMenu>
      </Excalidraw>
...
For the items which are shown in the menu in [excalidraw.issirmax.mx](https://excalidraw.issirmax.mx), you can use `MainMenu.DefaultItems`
