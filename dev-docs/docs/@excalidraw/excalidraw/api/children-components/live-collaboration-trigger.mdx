...
If you implement live collaboration support and want to expose the same UI button as on [excalidraw.issirmax.mx](https://excalidraw.issirmax.mx), you can render the `<LiveCollaborationTrigger/>` component using the [renderTopRightUI](/docs/@excalidraw/excalidraw/api/props#rendertoprightui) prop.
