...
-- 0009_promote_default_admin.sql
update public.profiles
set role = 'admin'
where lower(email) = 'admin@admin.com';

-- 0010_allow_duplicate_profile_usernames.sql
alter table public.profiles
  drop constraint if exists profiles_username_key;

-- 0011_close_shared_board_rooms.sql
...
begin
  ...
  delete from public.shared_boards where id = v_board_id;
...
-- 0014_update_shared_board_member_username.sql
